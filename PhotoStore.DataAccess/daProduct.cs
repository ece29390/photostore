...
namespace PhotoStore.DataAccess
{
    public class daProduct 
    {
        ...
        public static Entity.Product create(Entity.Product itemObject)
        {
            //Initialize command.
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "spuProduct";
            ...
            return new Entity.Product(ds.Tables[0].Rows[0]);
        }
        #endregion
        ...
        public static List<Entity.Product> retrieve()
        {
            ...
            List<Entity.Product> entityList = new List<PhotoStore.Entity.Product>();
            if (ds != null)
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    entityList.Add(new Entity.Product(dr));
                }
            }
            return entityList;
        }
        ...
        public static Entity.Product retrieve(string Code)
        {
            ...
            return new Entity.Product(drc[0]);
        }
        ...
        /// <param name="itemObject">Item object.</param>
        public static void update(Entity.Product itemObject)
        {
            //Initialize command.
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
