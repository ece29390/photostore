...
{
    public class daEmployeeGroup 
    {
        private static string _TableName = "EmployeeGroup";

        #region Create
        /// <summary>Create an item entry in the database.</summary>
        /// <param name="itemObject">Item object.</param>
        public static Entity.EmployeeGroup create(Entity.EmployeeGroup itemObject)
        {
            //Initialize command.
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "spuEmployeeGroup";
            ...
            return new Entity.EmployeeGroup(ds.Tables[0].Rows[0]);
        }
        #endregion
        ...
        public static List<Entity.EmployeeGroup> retrieve()
        {
            ...
            List<Entity.EmployeeGroup> entityList = new List<PhotoStore.Entity.EmployeeGroup>();
            if (ds != null)
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    entityList.Add(new Entity.EmployeeGroup(dr));
                }
            }
            return entityList;
        }
        ...
        public static Entity.EmployeeGroup retrieve(int Id)
        {
            ...
            return new Entity.EmployeeGroup(dr);
        }
        ...
        public static Entity.EmployeeGroup retrieve(string Code)
        {
            ...
            return new Entity.EmployeeGroup(drc[0]);
        }
        #endregion
        ...
        /// <param name="itemObject">Item object.</param>
        public static void update(Entity.EmployeeGroup itemObject)
        {
            //Initialize command.
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
