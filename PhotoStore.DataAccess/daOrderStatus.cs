...
{
    public class daOrderStatus 
    {
        private static string _TableName = "OrderStatus";

        #region Create
        /// <summary>Create an item entry in the database.</summary>
        /// <param name="itemObject">Item object.</param>
        public static Entity.OrderStatus create(Entity.OrderStatus itemObject)
        {
            //Initialize command.
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "spuOrderStatus";
            ...
            return new Entity.OrderStatus(ds.Tables[0].Rows[0]);
        }
        #endregion
        ...
        public static List<Entity.OrderStatus> retrieve()
        {
            ...
            List<Entity.OrderStatus> entityList = new List<PhotoStore.Entity.OrderStatus>();
            if (ds != null)
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    entityList.Add(new Entity.OrderStatus(dr));
                }
            }
            return entityList;
        }
        ...
        public static Entity.OrderStatus retrieve(long Id)
        {
            DataRow dr = daHelper.executeSelectById(_TableName, Id);
            return new Entity.OrderStatus(dr);
        }
        ...
        public static Entity.OrderStatus retrieve(string Code)
        {
            ...
            return new Entity.OrderStatus(drc[0]);
        }
        ...
        /// <param name="itemObject">Item object.</param>
        public static void update(Entity.OrderStatus itemObject)
        {
            //Initialize command.
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
